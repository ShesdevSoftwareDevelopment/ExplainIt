...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-145621189-3"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());
	
	gtag('config', 'UA-145621189-3');
	</script>
	...
	<!-- TITLE -->
	<title>פיזיקה לבגרות | מכניקה</title>
	
	<!-- DESCRIPTION -->
	<meta name="description" content='פיזיקה לבגרות יא | מכניקה. עם הקורס הזה תוכל/י ללמוד את החומר של כל השנה ב-5 שעות, 52 דקות ו-30 שניות.'>
...
<body style="width:100%;position:relative;">
	...
	<div class="section-1 rectangle-2">
		...
		<div class="desktop" style="background-color:#2a6458;color:#faae1d;margin-bottom:10px;">
			...
			<h4 style="color:white;font-weight:100;">
				כל החומר שצריך לדעת לי' וי"א ב-12 סרטונים
			</h4>
			
			<h4 style="color:white;font-weight:100;">
				באורך 5 שעות, 52 דקות ו-30 שניות
			</h4>
			...
			<div style="width:100%;">
				<table style="width:100%;">
					<tr>
						...
						<td>
							<div style="width:75%;">
								<h6>עם 12 סרטונים באורך כולל של 5 שעות, 52 דקות ו-30 שניות את/ה יכול ללמוד לבד את החומר לבגרות.</h6>
							</div>
						</td>
					</tr>
	...
	*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
	...
	this.page.url = 'https://course006.explainit.online/index.php';  // Replace PAGE_URL with your page's canonical URL variable
	this.page.identifier = 'signup'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
	};
	
	(function() { // DON'T EDIT BELOW THIS LINE
	var d = document, s = d.createElement('script');
	s.src = 'https://https-course006-explainit-online-index.disqus.com/embed.js';
