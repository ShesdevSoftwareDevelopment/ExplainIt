...
<!-- LINKS -->
	...
	<!-- DESCRIPTION -->
	<meta name="description" content='פיזיקה לבגרות יא - מכניקה. עם הקורס הזה תוכלו לקבל את כל ההסברים על החומר.'>
...
<body style="width:100%;position:relative;">
	...
	<div id="middle_content" style="float:right;width:100%;text-align:center;max-width:720px;">
		...
		<div>
			...
			<!-- DISCOUNT -->
			<div id="div_promotion" style="width:100%;margin:auto;text-align:center;float:right;display:none;">
			...
			<div style="width:100%;margin:auto;text-align:center;float:right;">
				...
				<p style="margin-top:0px;">	
					...
					<br><br>
					עלות הקורס <b>200 ש"ח</b>, ותוכל/י לצפות בו <b>כמה שתרצה/י</b>. הקורס ישאר שלך לתמיד.
				</p>
