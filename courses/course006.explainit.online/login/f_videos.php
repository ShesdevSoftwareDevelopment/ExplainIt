...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	else//MAIL FOUND
	{
		...
		//ATTRIBUTES
		$s="Explainit Online - קורס ".$course_number_007." - החלפת סיסמה";
		...
		$message .= '<div style="width:50%;margin:auto;">
						<a href="https://course'.$course_number_007.'.explainit.online/php/v_fi/v_1_videos.php?e='.$t.'&h='.$P_h.'">
...
<!-- ENCODING -->
	...
	<!-- TITLE -->
	<title>פיזיקה לבגרות | מכניקה | שכחתי סיסמה</title>
