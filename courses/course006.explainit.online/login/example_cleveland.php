...
// SELF POST
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')//POST REQUEST SUBMITTED
	{
		...
		{
			$_SESSION['message_1']="יש כבר משתמש עם מייל כזה <br><h6 id='a_2' style='margin:2px auto;' class='yellow'>הכנס/י מייל אחר</h6>";
			
			//LOGIN LINK DISPLAYED
			echo '<script>setTimeout(function(){document.getElementById("c").click();}, 500);</script>';
		}
				...
				*/
					...
					if($flag_registration)
					{
						...
						// mail($t,$s,$m,"FROM:".$e."\r\n"."Content-Type: text/html;charset=utf-8");
						  ...
						  //ATTRIBUTES
						  $f = "fiveminutes003, registration@explainit.online";
						  $f_1="XO - ".$course_number_." - NEW SIGNUP";
						  $t=$E_mail;
												  
						  //HEADERS
						  $headers_2 = "From: registration@explainit.online\r\n";
						  $headers_2 .= "Reply-To:registration@explainit.online\r\n";
					...
					// 	//ATTRIBUTES
					// 	$t=$E_mail;
					// 	$s="Explainit Online - קורס ".$course_number_." - אישור חשבון";
					...
					// 	//<a href="https://www.course002.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
					// 	$message .= '<div style="width:50%;margin:auto;">
					// 					<a href="https://course006.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
					...
					// 	mail($t,$s, $message, $headers);
						...
						// Multiple recipients
						$to = $E_mail; // note the comma
					
						// Subject
						$subject = "Explainit Online - קורס 006 - אישור חשבון";
					
						// Message
						$message = '
						<html lang="iw" dir="rtl">
						<body>
						<img style="width:100%;" src="https://www.course001.explainit.online/img/mail/welcome.png" alt="ברוך/ה הבא/ה" />
						<div style="width:100%;margin:auto;text-align:center;">
							<h4>לאישור החשבון:</h4>
							<div style="width:50%;margin:auto;">
								<a href="https://course006.explainit.online/php/v_fi/v_videos.php?e='.$to.'&h='.$P_h.'">
									<button style="width:100%;
  												border-radius: 5px;
  												-moz-border-radius: 5px;
  												-webkit-border-radius: 5px;
				...
				{
					//MESSAGE
					$_SESSION['message_1']="סיסמה לא ארוכה מספיק <br><h6 id='a_1' style='margin:2px auto;' class='yellow'>(צריך מינימום 8 אותיות ומספרים)</h6>";
					
					//REFILL INPUT FIELD
					//echo '<script>setTimeout(function(){document.getElementById("a_1").click();}, 200);</script>';
				}   
			}//PASSWORDS DON'T MATCH
			else
			{
				//MESSAGE
				$_SESSION['message_1']="הסיסמאות לא מתאימות<h6 id='a_1' style='margin:2px auto;' class='yellow'>נסה/י שוב</h6>";
...
<head>
	...
	<!-- TITLE -->
	<title>פיזיקה לבגרות | מכניקה | הרשמה</title>
...
.container {
    display: block;
    position: relative;
    padding-right: 20px;/* CHANGED FROM: padding-left: 35px; */
...
.bottom-line-input
	{
		...
		outline-style: none;
      	...
      	border-bottom: 1px solid #faae1d;
...
<div id="top-div" style="width:100%;">
	<img id="background_img_desktop" src="../img/login/div/SIGNUP-DESKTOP.jpg">
	<img id="background_img_mobile" src="../img/login/div/SIGNUP-MOBILE.jpg">
</div>

<div id="middle-div" style="direction:rtl;text-align:center;">
	
	<h1 style="margin:0px auto;" class="yellow">הרשמה</h1>
	
	<div style="width:10%;margin:auto;">
		<hr>
	</div>
	
	<h4 id='u_1' style="margin:0px auto;" class="yellow"><?=$_SESSION['message_1'] ?></h4>
	
	<i class="em em-writing_hand" style="font-size:12px;"></i>
	...
	<!-- OUTPUT 10 -->
	<form action="example_cleveland.php" method="post" enctype="multipart/form-data" autocomplete="on" style="margin:20px auto 0px;">
		
		<input class="bottom-line-input" id="input_2" style="margin:4px auto;padding:2px;width:200px;text-align:center;" type="email" placeholder="מייל" name="e_mail" onfocus="tell_mail()" autocomplete="mail" required><br>
		<input class="bottom-line-input" style="margin:4px auto;padding:2px;width:200px;text-align:center;" type="password" placeholder="סיסמה" name="pass_word" autocomplete="new-password" onfocus="tell_pass()" required><br>
		<input class="bottom-line-input" style="margin:4px auto;padding:2px;width:200px;text-align:center;" type="password" placeholder="סיסמה מחדש" name="pass_word_2" autocomplete="new-password" onfocus="tell_pass_2()" required><br>
			
		<div style="width:200px;text-align:right;direction:rtl;margin:auto;">
			<label class="container" style="color:white;">
				אני מסכים/ה ל<!-- TERMS OF SERVICE --><!-- OUTPUT 11 --><a href="../terms/Terms of Service 04.04.19.pdf" target="_blank">תנאי השימוש</a> ול<!-- PRIVACY STATEMENT --><!-- OUTPUT 12 --><a href="../terms/Privacy_Statement_02.08.18.pdf" target="_blank">מדיניות הפרטיות</a>.
		...
		<div style="width:25%;margin:auto;">
			<input class="responsive_input_4 button" style="width:100%;margin-top:30px;" type="submit" value="הרשמה" name="register" onclick="return testcheck()">
		</div>
	</form>
	...
	<div id="a_9" style="display:none;">
		...
		<h6 style="margin:0px 0px 5px 0px;" class="yellow">התחברות זה בלינק הזה:</h6>
	...
	<div style="width:10%;margin:0px auto 10px;padding-bottom:10px;">
		<hr>
	</div>	
</div>
...
setTimeout(function(){document.getElementById("u_1").click();}, 50);
