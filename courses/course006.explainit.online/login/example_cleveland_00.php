					...
					*/	
					...
					/* HTML MAIL WITH PHP *//* https://css-tricks.com/sending-nice-html-email-with-php/ */
						...
						$message .= '<div style="width:50%;margin:auto;">
										<a href="https://course'.$course_number_007.'.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
...
<div style="direction:rtl;text-align:center;">
	...
	<form action="example_cleveland.php" method="post" enctype="multipart/form-data" autocomplete="on">
		...
		<input id="input_2" style="margin:4px auto;padding:2px;width:200px;text-align:center;" type="email" placeholder="מייל" name="e_mail" onfocus="tell_mail()" autocomplete="mail" required><br>
