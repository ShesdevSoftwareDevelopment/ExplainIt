...
//FUNCTIONS
	...
	function check_num($n,$mail)
	{
		...
		if (mysqli_num_rows($query) > 0)
		{	
			//PUTTING THE MAIL THE USER ENTERED IN SESSION VAR
			...
			//CONFIRMATION NUMBER EXISTS IN LIST AND HASN'T BEEN USED
			return(1);
		}//CONFIRMATION NUMBER FOUND
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($_SESSION['count']<2)
	{
				...
				*/	
					...
					if($row['U_AP'] == 1)
					{
						...
						*/	
						...
						if(mysqli_num_rows($query) > 0)
						{
							...
							*/
							...
							if($code_3 == 'N')//NOT CONNECTED FROM OTHER DEVICE
							{
								...
								$f_1="Explainit Online - קורס ".$course_number_." - P04 - שימוש במספר אישור";
						...
						else
						{
							...
							//ATTRIBUTES//OUTPUT
							$f = "registration@explainit.online";
							$f_1="Explainit Online - קורס ".$course_number_." - P04 - סיסמה לא נכונה";
				...
				else
				{
					...
					if(isset($U_name)&&$U_name!='')
					{
						...
						//ATTRIBUTES//OUTPUT
						$f = "registration@explainit.online";
						$f_1="Explainit Online - קורס ".$course_number_." - P04 - אין מייל כזה";
		...
		else
		{
			...
			//ATTRIBUTES//OUTPUT
			$f = "registration@explainit.online";
			$f_1="Explainit Online - קורס ".$course_number_." - P04 - שימוש במספר אישור לא נכון";
	...
	else
	{
		...
		$f = "registration@explainit.online";
		$f_1="Explainit Online - קורס ".$course_number_." - P04 - ניסיון תשלום של יותר מ-4 פעמים";
...
<div style="direction:rtl;text-align:center;">
	...
	<!-- SELF POST --><!-- OUTPUT 12 -->
	<form action="example_cleveland_l_videos_4.php" method="post" enctype="multipart/form-data" autocomplete="on">
