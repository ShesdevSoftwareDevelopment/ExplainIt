			...
			else
			{
				...
				*/
				...
				if($query)
				{
					...
					//ATTRIBUTES
					$t=$E_mail;
					$s="Explainit Online - קורס ".$course_number_007." - החלפת סיסמה בהצלחה";
					...
					$f_1="Explainit Online - קורס ".$course_number_." - החלפת סיסמה בהצלחה";
...
else
{
	...
	//REPORT MAIL//OUTPUT//MAIL 
		//ATTRIBUTES
		$f = "registration@explainit.online";
		$f_1="".$course_number_." - DAA - V_2_VIDEOS";
