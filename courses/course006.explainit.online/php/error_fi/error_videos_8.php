...
//SESSION VARS
	$_SESSION['message_1']="<h1 style='margin-bottom:0px;'>יש בעיה עם מספר אישור התשלום</h1><div style='width:50%;margin:auto;'><hr></div><h4 id='c' style='margin:2px auto;'> אנא צור/י איתנו קשר ב-050-8523270</h4>";
?>
<head>
<!-- ENCODING -->
	<meta charset="utf-8">
