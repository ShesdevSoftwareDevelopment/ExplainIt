...
//SESSION VAR
	$_SESSION['message_1']="<h1 style='margin-bottom:0px;'>כשהתחברת היית על מכשיר אחר</h1><div style='width:50%;margin:auto;'><hr></div><h4 id='c' style='margin:2px auto;'>או שהחלפת רשת בין ווייפיי לרשת סלולרית. אנא התחבר/י שוב. בכל שאלה אנא צור/י איתנו קשר ב-<br>registration@explainit.online</h4>";
?>
<head>
<!-- ENCODING -->
	<meta charset="utf-8">
