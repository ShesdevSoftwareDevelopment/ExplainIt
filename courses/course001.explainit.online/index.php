...
<!-- LINKS -->
	...
	<!-- TITLE -->
	<title>Explainit Online - קורס 001</title>
	
	<!-- DESCRIPTION -->
	<meta name="description" content='קורס תנ"ך לבגרות, מלכים א.'>
	...
	<div style="width:100%;text-align:center;float:right;display:none;">
		...
		<div style="width:100%;">
			<!-- OUTPUT 07 --><!-- COURSE BANNER -->
				<img src="img/index/11.png" style="width:100%">
			</div>
		</header>
		...
		<!-- VIMEO PLAYER -->
		<!-- <iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/IWwqkArfdDI?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> -->
		<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/301448881?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
		<script src="https://player.vimeo.com/api/player.js"></script>
		<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/301449186?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
		<script src="https://player.vimeo.com/api/player.js"></script>
		<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/301449302?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
		<script src="https://player.vimeo.com/api/player.js"></script>
		<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/301449345?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
		<script src="https://player.vimeo.com/api/player.js"></script>
				...
				<tr class="b17">
					<td colspan="5" style="text-align:center;padding:2px 10px;border-right-style:none;position:relative;">
						...
						<div style="position:relative;">
							<a href="https://course002.explainit.online">
								<img src="https://explainit.online/preview/02.jpg" style="width:100%;">
							</a>
						</div>
					</td>
				</tr>
				...
				<tr class="b17">
					<td colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;">
						<div style="width:100%;text-align:center;">
							<!-- OUTPUT --><!-- SIGN UP PAGE --><a href="https://course002.explainit.online">
