...
//FUNCTIONS
	...
	function check_num($n,$mail,$U_name,$ip_address,$course_number)
	{
		...
		if (mysqli_num_rows($query) > 0)
		{
			...
			$f_1="Explainit Online - קורס ".$course_number." - P04";
			...
			$message .= '<h4>P04 - THIS MAIL ALREADY HAS BEEN PAID FOR</h4>';
			$message .= '<h4>מייל:</h4>';
	...
	//CONFIRMATION NUMBER FOUND
		...
		{	
			...
			{	
				//SENDING REPORT MAIL TO XO
					...
					$message = '<html lang="iw" dir="rtl"><body>';
					$message .= '<div style="width:100%;margin:auto;text-align:center;">';
					$message .= '<h4>P04 - CONFIRMATION NUMBER ALREADY HAS BEEN USED</h4>';
					$message .= '<h4>מייל:</h4>';
					$message .= '<h4>'.$U_name.'</h4>';
					$message .= '<h4>IP:</h4>';
					$message .= '<h4>'.$ip_address.'</h4>';
		...
		else
		{
			...
			$message = '<html lang="iw" dir="rtl"><body>';
			$message .= '<div style="width:100%;margin:auto;text-align:center;">';
			$message .= '<h4>P04 - VALID CONFIRMATION NUMBER WAS NOT FOUND</h4>';
			$message .= '<h4>מייל:</h4>';
			$message .= '<h4>'.$U_name.'</h4>';
			$message .= '<h4>IP:</h4>';
			$message .= '<h4>'.$ip_address.'</h4>';
	...
	function used_num($n,$mail,$U_name,$ip_address,$course_number)
	{
		...
		if (mysqli_num_rows($query) > 0)
		{
			//SENDING REPORT MAIL TO XO
				...
				$message = '<html lang="iw" dir="rtl"><body>';
				$message .= '<div style="width:100%;margin:auto;text-align:center;">';
				$message .= '<h4>P04 - THIS MAIL ALREADY HAS BEEN PAID FOR - DOUBLE CHECK</h4>';
				$message .= '<h4>מייל:</h4>';
				$message .= '<h4>'.$U_name.'</h4>';
				$message .= '<h4>IP:</h4>';
				$message .= '<h4>'.$ip_address.'</h4>';
		...
		else
		{
			//SENDING REPORT MAIL TO XO
				...
				$message = '<html lang="iw" dir="rtl"><body>';
				$message .= '<div style="width:100%;margin:auto;text-align:center;">';
				$message .= '<h4>P04 - UPDATING BY MAIL</h4>';
				$message .= '<h4>מייל:</h4>';
				$message .= '<h4>'.$U_name.'</h4>';
				$message .= '<h4>IP:</h4>';
				$message .= '<h4>'.$ip_address.'</h4>';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($_SESSION['count']<2)
	{
		...
		if($v == 1)
		{
			...
			{
				//PASSWORD LONG ENOUGH, RETRIEVING MAIL
				...
				*/	
					...
					if($row['U_AP'] == 1)
					{
						...
						*/	
						...
						if(mysqli_num_rows($query) > 0)
						{
							...
							*/
							...
							if($code_3 == 'N')//NOT CONNECTED FROM OTHER DEVICE
							{
								...
								//UPDATE USED NUMBER
								used_num($Num,$U_name,$U_name,$ip_address,$course_number);
								...
								$message = '<html lang="iw" dir="rtl"><body>';
								$message .= '<div style="width:100%;margin:auto;text-align:center;">';
								$message .= '<h4>P04 - שימוש במספר אישור</h4>';
								$message .= '<h4>מייל:</h4>';
								$message .= '<h4>'.$U_name.'</h4>';
						...
						else
						{
							...
							$message = '<html lang="iw" dir="rtl"><body>';
							$message .= '<div style="width:100%;margin:auto;text-align:center;">';
							$message .= '<h4>P04 - סיסמה לא נכונה</h4>';
							$message .= '<h4>מייל:</h4>';
							$message .= '<h4>'.$U_name.'</h4>';
							$message .= '<h4>מספר אישור:</h4>';
							$message .= '<h4>'.$Num.'</h4>';
				...
				else
				{
					...
					if(isset($U_name)&&$U_name!='')
					{
						...
						$message = '<html lang="iw" dir="rtl"><body>';
						$message .= '<div style="width:100%;margin:auto;text-align:center;">';
						$message .= '<h4>P04 - אין מייל כזה</h4>';
						$message .= '<h4>מייל:</h4>';
						$message .= '<h4>'.$U_name.'</h4>';
						$message .= '<h4>מספר אישור:</h4>';
						$message .= '<h4>'.$Num.'</h4>';
			...
			else
			{
				...
				$message = '<html lang="iw" dir="rtl"><body>';
				$message .= '<div style="width:100%;margin:auto;text-align:center;">';
				$message .= '<h4>P04 - PASSWORD NOT LONG ENOUGH</h4>';
				$message .= '<h4>מייל:</h4>';
				$message .= '<h4>'.$U_name.'</h4>';
				$message .= '<h4>מספר אישור:</h4>';
				$message .= '<h4>'.$Num.'</h4>';
		...
		else
		{
			...
			$message = '<html lang="iw" dir="rtl"><body>';
			$message .= '<div style="width:100%;margin:auto;text-align:center;">';
			$message .= '<h4>P04 - CONFIRMATION CODE NOT VALID</h4>';
			$message .= '<h4>מייל:</h4>';
			$message .= '<h4>'.$U_name.'</h4>';
			$message .= '<h4>IP:</h4>';
			$message .= '<h4>'.$ip_address.'</h4>';
	...
	else
	{
		...
		$message = '<html lang="iw" dir="rtl"><body>';
		$message .= '<div style="width:100%;margin:auto;text-align:center;">';
		$message .= '<h4>P04 - ניסיון תשלום של יותר מ-4 פעמים</h4>';
		$message .= '<h4>מייל:</h4>';
		$message .= '<h4>'.$U_name.'</h4>';
		$message .= '<h4>IP:</h4>';
		$message .= '<h4>'.$ip_address.'</h4>';
