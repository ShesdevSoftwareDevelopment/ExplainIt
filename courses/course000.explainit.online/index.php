...
<!-- Middle Content -->	
	...
	<div class="abs">
		...
		<div id="div_header_4" style="float:right;">
			...
			<a href="login/example_cleveland_l_videos.php">
				<input id="log_in" class="responsive_input_2 button" type="submit" value="התחברות" name="register">
			</a>
		</div>
		
		<div id="div_header_5" style="float:right;">
			<!-- OUTPUT -->
			<a href="login/first_time/first_time_2.php">
				<input id="log_in_2" class="responsive_input_3 button" type="submit" value="רוצה למכור את הקורס שלך?" name="register">
			</a>
		</div>
	</div>
		...
		<div style="width:100%;">
				<!-- OUTPUT -->
				<img src="img/index/img_snow_wide_3.png" style="width:100%">
			</div>
		</header>
		...
		<div id="div_first_time">
			<div style="width:100%;margin:auto;text-align:center;"> 
				...
				<!-- TEXT -->
				<p>
					אנחנו מוכרים מנוי לחבילת סרטונים להכנה לבגרות הקרובה בפיזיקה.
					
					עלות החבילה 199 ש"ח (במקום 299 ש"ח).
					
					תוכל לצפות בהם כמה זמן שתרצה עד לבחינה.
				</p>
		...
		<!-- YOUTUBE PLAYER -->
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/9zNBmmzkPEA?showinfo=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/sQHiquwQTiY?showinfo=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/52F5YSvZ7uY?showinfo=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/T2_yqJKZX-o?showinfo=0" frameborder="0" allowfullscreen></iframe> 
				...
				<table id="table_colors" style="margin-bottom:2px;width:100%;border-collapse:collapse;text-align:center;">
					<tr>
						<td style="width:50%;">
							<!-- BUTTON -->
							<div style="width:100%;margin:auto;">
								<input id="Algebra" class="responsive_input_4 button" style="width:100%;" type="submit" value="מכניקה" name="register">
							</div>
						</td>
						...
						<td style="width:50%;">
							<!-- BUTTON -->
							<div style="width:100%;margin:auto;">
								<input id="Series" class="responsive_input_4 button" style="width:100%;" type="submit" value="אלקטרומגנטיות" name="register">
							</div>
						</td>
					</tr>
					<tr>
						...
						<!-- BUTTON -->
							<div style="width:100%;margin:auto;">
								<input id="Probability" class="responsive_input_4 button" style="width:100%;" type="submit" value="קרינה וחומר" name="register">
							</div>
						</td>
						<td style="width:50%;">
							<!-- BUTTON -->
							<div style="width:100%;margin:auto;">
								<input id="all" class="responsive_input_4 button" style="width:100%;" type="submit" value="פיתרון בגרויות" name="register">
							</div>
						</td>
					</tr>
				</table>
	...
	<!-- FOOTER -->
	<footer id="footer_1" style="float:right;clear:both;width:100%;position:relative;display:none;">
	<!-- License Data -->	
			<div style="float:right;clear:both;text-align:right;">
				<div id="under_comments_2" class="dropbtn_2" style="display:inline-block;"><u>רישיון</u></div>
				<br>
				<p style="margin-top:0px;float:right;">אתר זה מתנהל לפי רישיון מסוג: <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"></a><a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">&nbsp;<img alt="Creative Commons License" style="border-width:0;vertical-align:text-top;" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png" /></a></p>
				<p style="margin-top:0px;float:right;">&nbsp;</p>
				<!-- OUTPUT -->
				<p style="margin-top:0px;float:right;">מאובטח על ידי: &nbsp;<img alt="Condo SSL" style="border-width:0;vertical-align:text-top;" src="img/ssl/comodo_secure_seal_76x26_transp.png"/></p>
			</div>
		</footer>
	</div>
	
	<!-- FOOTER -->
<!--	<footer id="footer_1" style="float:right;clear:both;width:100%;background-color:green;">
		<div style="width:100%;float:right;">
			<br>
			<hr>
		</div>
...
<!--		<div style="float:right;clear:both;text-align:right;">
			...
			<p style="margin-top:0px;float:right;">אתר זה מתנהל לפי רישיון מסוג: <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"></a><a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">&nbsp;<img alt="Creative Commons License" style="border-width:0;vertical-align:text-top;" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png" /></a></p>
			<p style="margin-top:0px;float:right;">&nbsp;</p>
			<p style="margin-top:0px;float:right;">מאובטח על ידי: &nbsp;<img alt="Condo SSL" style="border-width:0;vertical-align:text-top;" src="../ssl/comodo_secure_seal_76x26_transp.png"/></p>
		</div>
	</footer>
-->	
	<!-- FOOTER -->
<!--	<footer id="footer_1" style="float:right;clear:both;width:100%;background-color:blue;">
		<div style="width:100%;float:right;">
			<br>
			<hr>
		</div>
...
-->	
	...
	//clickability	
		...
		{
			<!-- OUTPUT -->
			$.post("php/metal_fi/metal_3_videos.php",
			{
				subject:"Series"	,
				subsubject:"Heshbonit"	,
		...
		{
			<!-- OUTPUT -->
			$.post("php/metal_fi/metal_4_videos.php",
			{
				subject:"Series"	,
				subsubject:"Heshbonit"	,
			},
		...
		{
			<!-- OUTPUT -->
			$.post("php/metal_fi/metal_6_videos.php",
			{
				subject:"Series"	,
				subsubject:"Heshbonit"	,
			},
