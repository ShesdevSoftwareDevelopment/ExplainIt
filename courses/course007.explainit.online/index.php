...
<!-- LINKS -->
	...
	<!-- TITLE -->
	<title>Explainit Online - קורס 007</title>
	
	<!-- DESCRIPTION -->
	<meta name="description" content='פיזיקה לבגרות יא - מכניקה. עם הקורס הזה תוכלו לקבל את כל ההסברים על החומר. סרטון חדש עולה כל יומיים.'>
...
<body style="width:100%;position:relative;">
	...
	<div id="middle_content" style="float:right;width:100%;text-align:center;max-width:720px;">
		...
		<div>
			...
			<div style="width:100%;margin:auto;text-align:center;float:right;"> 
				...
				<div id="div_header_4" style="float:right;text-align:center;">
					...
					<div style="width:49.99%;float:right;">
						<!-- OUTPUT 05 --><!-- LOGIN PAGE -->
						<a href="login/example_cleveland_l_videos.php">
							<img src="buttons/buttons_menu_06.jpg" style="width:100%;">
						</a>
					</div>
					...
					<div style="width:49.99%;float:right;">			
						...
						<a href="login/example_cleveland.php">
							<img src="buttons/buttons_menu_05.jpg" style="width:100%;">
						</a>
					</div>
				</div>
		...
		<div>
			...
			<!-- DISCOUNT -->
			<div id="div_promotion" style="width:100%;margin:auto;text-align:center;float:right;">
				<img src="img/promotion/promotion_25.jpg" style="width:100%;border-radius:20px;">
			</div>
			
			<div style="width:100%;margin:auto;text-align:center;float:right;">
				<!-- TEXT -->
				<p style="margin-bottom:0px;">
					<b>הי, שמעתי עליכם מחבר/ה. תסבירו לי למה אני צריך/ה אתכם.</b>
					<br><br>
					הבחינה עוד מעט, ולא היה לך זמן ללמוד. עכשיו, 
					יש לך זמן ללמוד, אבל לא הרבה. את/ה צריך הסבר של החומר שלא 
					יקח יותר מדי זמן, ובגלל זה אנחנו פה. 
					<br><br> 
					<b>סבבה, מי אתם?</b>
				</p>						
					
					<div style="text-align:center;float:right;">
						<img src="img/profile_banner/profile_banner.png" style="width:100%;border-radius:5px;">
					</div>
							
					<div style="text-align:center;display:inline-block;">
						קוראים לי אלעד, ואני מורה פרטי לפיזיקה במשרה מלאה. לפני כמה שנים פתחתי ערוץ יוטיוב שקוראים לו "פיזיקה שאפשר להבין". במקום
						שהחומר יהיה מפוזר בין סרטונים החלטתי לרכז אותו כאן, במסגרת קורס אחד.
					</div>
					
				<p style="margin-top:0px;">	
					<br>
					<b>טוב. כמה עולה התענוג?</b>
					<br><br>
					עלות הקורס <b>90 ש"ח</b>, ותוכל/י לצפות בו <b>כמה שתרצה/י</b>. הקורס ישאר שלך לתמיד.
				</p>
				
					<div style="text-align:center;">
						<img src="img/forever/forever_02.jpg" style="width:100%;border-radius:20px;">
					</div>
				
				<p>
					<b>איך אוכל לדעת שהקורס מתאים לי?</b>
					<br><br>
					הבאנו לכם <span id="example_video_link" style="color:blue;">הסבר מלא של נושא אחד</span> שתוכלו להתרשם.
					בכל שעור גם שמנו את אחד מהלוחות שעוברים עליהם בשיעור, עם פירוט, כדי שתוכלו לבדוק בעצמכם אם התוכן מתאים לכם.
					אם אתם מתחברים לצורת ההסבר בסרטון הדוגמה, אין סיבה שלא תתחברו להסברים בשעורים האחרים. המסביר הוא אותו מסביר (אני) והטכניקה היא אותה טכניקה, של צילום מסך עם קריינות.
					<br><br> 
					<b>חשוב לי לדעת בדיוק על מה עוברים בשעורים.</b>
					<br><br>
					בשעורים אנחנו עוברים על החומר שמתואר בלוח הדוגמה, ובחלק מהשעורים יש עוד נושאים ועוד לוחות. בגלל זה שמנו לכם
					למטה פירוט של נושאים ומושגים נוספים, אם יש. 
				</p>
				
					<div style="text-align:center;">
						<img src="img/example_board/example_board.jpg" style="width:100%;border-radius:20px;">
					</div>
					
				<p>
					<b>אוקיי, השקעתי וקראתי עד לכאן. מה אני אמור/ה לעשות עכשיו?</b>
					<br><br>
					קחו את הזמן, תראו את הסרטון לדוגמה ותחליטו אם אופן ההסבר בא לכם טוב.
					הקורס יהיה שלכם לתמיד. לא מנוי חודשי או שנתי, <b>לתמיד</b>.
					<br><br>
					<b>הבנתי. משהו אחרון לסיכום?</b>
					<br><br>
					המטרה שלנו היא שהקורס הזה יסגור
					לכם את הפינה של פיזיקה יא לבגרות לכל החיים, גם אם תצטרכו את זה באוניברסיטה, הקורס יחכה לכם כאן.
					<br><br>
					<b>תודה.</b>
					<br><br>
					בבקשה. הנה סרטון לדוגמה שמסביר את המבוא לקינמטיקה ב-18:35 דקות. 
				</p>
		...
		<!-- EXAMPLE VIDEO DIV -->
		<div id="example_video" style="float:right;width:100%;display:block;">
			<h1 style="margin:0px auto;">סרטון לדוגמה</h1>
		...
		<!-- CLASSES INTRO DIV -->
		<div style="float:right;text-align:center;width:100%;margin-top:0px;position:relative;top:0px;">
			<div style="width:100%;margin:auto;text-align:center;"> 
				...
				<!-- TEXT -->
				<p>
					שעורי הקורס מפורטים למטה. כל נושא כולל מעבר
					על כל הנוסחאות הרלוונטיות בדף הנוסחאות.
				</p>
				<!-- HR -->
				<div style="width:50%;margin:auto;">
					<hr>
		...
		<div id="div_header_3" style="float:right;text-align:center;font-size:24px;position:relative;top:0px;width:100%;">
			...
			<!-- HEADER -->
			<h1 style="margin-bottom:0px 0px 0px 0px;font-size:24px;">שעורים בקורס</h1>						
			...
			<div id="div_table_drills" style="width:100%;margin:auto;text-align:center;">
				<h3 id="choose_subjects" style="font-size:16px;">לחצ/י כדי לראות את סיכום השעור</h3>
			</div>
		...
		<div style="float:right;clear:both;text-align:center;margin-top:5px;width:100%;text-align:center;">
			<table style="width:100%;">
				<tr>
					<td colspan="6">
						<!-- OUTPUT --><!-- ABOUT -->
						<a href="https://explainit.online/physics_01/index.php">
				...
				<tr>			
					<td style="width:16.67%;">	
						...
						<a href="terms/about_xo.jpg">
							<img src="buttons/01.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
					<td style="width:16.67%;">	
						<!-- OUTPUT 13 --><!-- TERMS -->
						<a href="terms/Terms of Service 04.04.19.pdf">
							<img src="buttons/02.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
					<td style="width:16.67%;">	
						<!-- OUTPUT 14 --><!-- PRIVACY -->
						<a href="terms/Privacy_Statement_02.08.18.pdf">
							<img src="buttons/03.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
					<td style="width:16.67%;">	
						<!-- OUTPUT 15 --><!-- CONTACT PAGE -->
						<a href="contact/contact.php">
							<img src="buttons/04.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
					<td style="width:16.67%;">	
						<!-- OUTPUT 15_1 --><!-- CONTACT PAGE -->
						<a href="credits/credits.php">
							<img src="buttons/05.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
					<td style="width:16.67%;">	
						<!-- OUTPUT 06 --><!-- INTERESTED IN WEBSITE -->
						<a href="login/first_time/first_time_2.php">
							<img src="buttons/06.jpg" style="width:100%;border-radius:10px;">
						</a>
					</td>	
				</tr>
			</table>
					...
					<td colspan="5" style="text-align:center;padding:2px 10px;border-right-style:none;position:relative;">
						...
						<div style="position:relative;">
							<a href="https://course005.explainit.online">
								<img src="https://explainit.online/img/04_820x463_005.jpg" style="width:100%;">
							</a>
						</div>
					</td>
				</tr>
				...
				<tr class="b17">
					<td colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;">
						<div style="width:100%;text-align:center;">
							<!-- OUTPUT --><!-- SIGN UP PAGE --><a href="https://course005.explainit.online">
	...
	//clickability	
		$("#choose_subjects").click(function()
		{
			...
			$.post("php/metal_fi/metal_5_videos.php",
			{
				...
				function(data, status)
				{
					...
					//CLICKS
					//b
					setTimeout(function(){$("#b1_1").click();},7000);
					setTimeout(function(){$("#b2_1").click();},7000);
					setTimeout(function(){$("#b3_1").click();},7000);
					setTimeout(function(){$("#b4_1").click();},7000);
					setTimeout(function(){$("#b5_1").click();},7000);
					setTimeout(function(){$("#b6_1").click();},7000);
					setTimeout(function(){$("#b7_1").click();},7000);
					setTimeout(function(){$("#b8_1").click();},7000);
					setTimeout(function(){$("#b9_1").click();},7000);
					setTimeout(function(){$("#b10_1").click();},7000);
					setTimeout(function(){$("#b11_1").click();},7000);
					setTimeout(function(){$("#b12_1").click();},7000);
					setTimeout(function(){$("#b13_1").click();},7000);
					setTimeout(function(){$("#b14_1").click();},7000);
					setTimeout(function(){$("#b15_1").click();},7000);
					setTimeout(function(){$("#b16_1").click();},7000);
		...
		$("#example_video_link").click(function()
		{	
			$('html, body').animate({ scrollTop:  $("#example_video").offset().top - 50 }, 1500);
		});
		
		//opacity for loader
		$('#div_header_3, #div_1, #div_table_drills, #hr_number_1, #footer_1, #new_comment, #new_comment_2, #div_promotion').animate({opacity:1},1000);
