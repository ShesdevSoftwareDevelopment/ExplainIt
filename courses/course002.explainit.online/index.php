...
<!-- LINKS -->
	...
	<!-- TITLE -->
	<title>Explainit Online - קורס 002</title>
	
	<!-- DESCRIPTION -->
	<meta name="description" content='קורס תנ"ך לבגרות, מלכים ב, עמוס וישעיה.'>
	...
	<!-- Hotjar Tracking Code for https://course002.explainit.online -->
	<script>
		(function(h,o,t,j,a,r){
			h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
			h._hjSettings={hjid:1287838,hjsv:6};
				...
				<tr class="b17">
					<td colspan="5" style="text-align:center;padding:2px 10px;border-right-style:none;position:relative;">
						...
						<div style="position:relative;">
							<a href="https://course003.explainit.online">
								<img src="https://explainit.online/preview/03.png" style="width:100%;">
							</a>
						</div>
					</td>
				</tr>
				...
				<tr class="b17">
					<td colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;">
						<div style="width:100%;text-align:center;">
							<!-- OUTPUT --><!-- SIGN UP PAGE --><a href="https://course003.explainit.online">
