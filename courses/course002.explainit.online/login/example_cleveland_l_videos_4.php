...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($_SESSION['count']<2)
	{
						...
						if(mysqli_num_rows($query) > 0)
						{
							...
							*/
							...
							if($code_3 == 'N')//NOT CONNECTED FROM OTHER DEVICE
							{
								...
								$f_1="Explainit Online - קורס 002 - P04 - שימוש במספר אישור";
		...
		else
		{
			...
			//ATTRIBUTES//OUTPUT
			$f = "registration@explainit.online";
			$f_1="Explainit Online - קורס 002 - P04 - שימוש במספר אישור לא נכון";
	...
	else
	{
		...
		$f = "registration@explainit.online";
		$f_1="Explainit Online - קורס 002 - P04 - ניסיון תשלום של יותר מ-4 פעמים";
