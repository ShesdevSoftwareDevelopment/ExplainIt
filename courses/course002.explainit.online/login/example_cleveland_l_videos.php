...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	*/	
	...
	else
	{
		...
		$f_1="Explainit Online - קורס 002 - בעיות עם החשבון";
...
<body>
	<div style="direction:rtl;text-align:center;">
		...
		<form action="example_cleveland_l_videos.php" method="post" enctype="multipart/form-data" autocomplete="on" style="margin-bottom:0px;">
			...
			<div style="font-size:14px;"><!-- OUTPUT 11 --><a href="f_videos.php">שכחתי סיסמה</a></div>
			<div style="font-size:14px;"><!-- OUTPUT 12 --><a href="example_cleveland_l_videos_4_multi.php">אישור תשלום</a></div>
