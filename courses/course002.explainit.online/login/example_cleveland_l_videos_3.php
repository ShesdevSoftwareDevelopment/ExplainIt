...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
					...
					if($row['U_AP'] == 1)
					{
						...
						*/	
						...
						if(mysqli_num_rows($query) > 0)
						{
							...
							*/
							...
							if($code_3 == 'N')//NOT CONNECTED FROM OTHER DEVICE
							{
								...
								$f_1="Explainit Online - קורס 002 - P03 - שימוש במספר אישור";
						...
						else
						{
							...
							echo '<script>setTimeout(function(){$("#d").click();}, 0100);</script>';
	...
	else
	{
		...
		$f = "registration@explainit.online";
		$f_1="Explainit Online - קורס 002 - P03 - ניסיון תשלום של יותר מ-4 פעמים";
