...
// SELF POST
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')//POST REQUEST SUBMITTED
	{
		...
		{
			$_SESSION['message_1']="יש כבר משתמש עם מייל כזה <br><h6 id='a_2' class='yellow' style='margin:2px auto;'>הכנס/י מייל אחר</h6>";
		...
		else//NO MAIL FOUND, CONTINUE SIGN UP
		{
				...
				*/
					...
					*/	
					...
					/* HTML MAIL WITH PHP *//* https://css-tricks.com/sending-nice-html-email-with-php/ */
						...
						//				<a href="https://course'.$course_number_.'.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
						...
						// Subject
						$subject = "Explainit Online - קורס 506 - אישור חשבון";
						...
						<div style="width:100%;margin:auto;text-align:center;">
							...
							<div style="width:50%;margin:auto;">
								<a href="https://course005.explainit.online/php/v_fi/v_videos.php?e='.$to.'&h='.$P_h.'">
									<button style="width:100%;
  												border-radius: 5px;
  												-moz-border-radius: 5px;
  												-webkit-border-radius: 5px;
				...
				{
					//MESSAGE
					$_SESSION['message_1']="סיסמה לא ארוכה מספיק <br><h6 id='a_1' class='yellow' style='margin:2px auto;'>(צריך מינימום 8 אותיות ומספרים)</h6>";
			...
			{
				//MESSAGE
				$_SESSION['message_1']="הסיסמאות לא מתאימות<h6 id='a_1' class='yellow' style='margin:2px auto;'>נסה/י שוב</h6>";
...
<head>
	...
	<!-- TITLE -->
	<title>פיזיקה לבגרות | חשמל ומגנטיות | הרשמה</title>
