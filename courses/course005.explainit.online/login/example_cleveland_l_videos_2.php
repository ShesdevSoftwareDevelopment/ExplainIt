...
//POST METHOD
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['from_login_page']) && $_SESSION['from_login_page'] == 3)
{
	...
	*/	
		...
		$f_1="Explainit Online - קורס ".$course_number_." - הגעה לדף ניתוק חשבון";
		...
		$message .= '<h4>Registered IP:</h4>';
		$message .= '<h4>'.$_SESSION['original_ip'].'</h4>';
		$message .= '<h4>Current IP:</h4>';
				...
				if($row['U_AP'] == 1)
				{
					...
					*/	
					...
					if(mysqli_num_rows($query) > 0)
					{
						...
						*/
						...
						if($code_3 == 'Y')
						{
							...
							//REPORT MAIL//OUPTUT 00
							$f = "registration@explainit.online";
							$f_1="Explainit Online - קורס ".$course_number_." - ניתוק חשבון";
					...
					else
					{
						...
						$f = "registration@explainit.online";
						$f_1="Explainit Online - קורס ".$course_number_." - סיסמה לא נכונה בניסיון התחברות ממכשיר אחר";
	...
	else
	{
		...
		$f = "registration@explainit.online";
		$f_1="Explainit Online - קורס ".$course_number_." - ניתוק חשבון - ניסיון התחברות > 4 פעמים";
...
else
{
	//REPORT MAIL//OUPTUT 04
	$f = "registration@explainit.online";
	$f_1="Explainit Online - קורס ".$course_number_." - DIRECT ACCESS ATTEMPT - דף ניתוק חשבון";
	...
	//MESSAGE
	$message = '<html lang="iw" dir="ltr"><body>';
	$message .= '<div style="width:100%;margin:auto;text-align:center;">';
	$message .= '<h4>IP:</h4>';
