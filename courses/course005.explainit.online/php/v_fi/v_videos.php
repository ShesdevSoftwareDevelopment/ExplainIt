...
if (isset($_GET['e']) && !empty($_GET['e']) AND isset($_GET['h']) && !empty($_GET['h']))
{
	...
	else
	{
		...
		$f_1="".$course_number_." - הפעלת חשבון";
		$t=$e_;
...
else
{
	...
	if(isset($_SESSION['v_wait']))
	{
		...
		{
			$_SESSION['message_1']="לחץ/י על הקישור שנשלח במייל<br><div style='width:50%;margin:auto;'><hr></div><h4 id='c' style='margin:2px auto;direction:rtl;'>כדי להפעיל את החשבון. לפעמים המייל מגיע לספאם אז כדאי לבדוק גם שם.</h4>";	
		}
		...
		else
		{
			...
			if($_SESSION['m']== 1)
			{
				$_SESSION['message_1']="לחץ/י על הלינק שנשלח במייל<br><div style='width:50%;margin:auto;'><hr></div><h4 id='c' style='margin:2px auto;direction:rtl;'>כדי להשלים את החלפת הסיסמה. לפעמים המייל מגיע לספאם אז כדאי לבדוק גם שם. </h4>";
			}
...
<body>
	...
	<div style="text-align:center;width:100%;">
		<h1 style="margin-bottom:0px;direction:rtl;"><?=$_SESSION['message_1'] ?></h1>
	</div>
