...
<body style="width:100%;position:relative;">
	...
	<div id="middle_content" style="float:right;right:0px;float:right;width:100%;;max-width:720px;">
		...
		<div id="div_header_3" style="float:right;text-align:center;font-size:24px;position:relative;top:0px;width:100%;">
			<!-- HEADER -->
			<h1 id="page_h1" style="margin-bottom:0px;font-size:24px;">סרטונים לפי נושא</h1>						
						...
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b1_1" class="responsive_input_4 button a1_b1_c1_main" style="width:100%;">כח חשמלי&nbsp; <span id="a1_b1_c1_views"></span></button>
								</div>
							</th>
						</tr>
								...
								<table style="width:100%;">
									<tr>
										...
										<td style="text-align:center;position:relative;">
											...
											<!-- BUTTON -->
											<button id="play_icon_a1_b1_c1" class="responsive_input_4 button" style="width:49%;margin:auto;">נגן סרטון <i class="fa fa-play-circle-o" style="font-size:16px;"></i></button>
											
														
											<!-- BUTTON -->
											<a href="PDF/Notebook_01.pdf" style="text-decoration:none;">
												<div style="width:49%;margin:auto;" class="responsive_input_4 button">
													חוברת שעור<i class="fa fa-cloud-download" style="font-size:16px;"></i>
												</div>
											</a>
										</td>
									</tr>
			...
			<!-- SUBJECT 02 -->
				<table id="table_b2" style="margin-top:2.5px;">
					<tr>
						...
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b2_1" class="responsive_input_4 button a1_b1_c2_main" style="width:100%;">שדה חשמלי&nbsp; <span id="a1_b1_c2_views"></span></button>
							</div>
						</th>
					</tr>
			...
			<!-- SUBJECT 03 -->
				<table id="table_b3" style="margin-top:2.5px;">
					<tr>
						...
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b3_1" class="responsive_input_4 button a1_b1_c3_main" style="width:100%;">חוק גאוס&nbsp; <span id="a1_b1_c3_views"></span></button>
							</div>
						</th>
					</tr>
			...
			<!-- SUBJECT 04 -->
				<table id="table_b4" style="margin-top:2.5px;">
					<tr>
						...
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b4_1" class="responsive_input_4 button a1_b1_c4_main" style="width:100%;">פוטנציאל חשמלי&nbsp; <span id="a1_b1_c4_views"></span></button>
							</div>
						</th>
					</tr>
			...
			<!-- SUBJECT 05 -->
				<table id="table_b5" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b5_1" class="responsive_input_4 button a1_b1_c5_main" style="width:100%;">אנרגיה חשמלית&nbsp; <span id="a1_b1_c5_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 06 -->
				<table id="table_b6" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b6_1" class="responsive_input_4 button a1_b1_c6_main" style="width:100%;">קיבול&nbsp; <span id="a1_b1_c6_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 07 -->
				<table id="table_b7" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b7_1" class="responsive_input_4 button a1_b1_c7_main" style="width:100%;">מעגלי זרם&nbsp; <span id="a1_b1_c7_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 08 -->
				<table id="table_b8" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b8_1" class="responsive_input_4 button a1_b1_c8_main" style="width:100%;">כא"מ ומתח הדקים&nbsp; <span id="a1_b1_c8_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 09 -->
				<table id="table_b9" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b9_1" class="responsive_input_4 button a1_b1_c9_main" style="width:100%;">חוקי קירכהוף (בתוספת דוגמאות)&nbsp; <span id="a1_b1_c9_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 10 -->
				<table id="table_b10" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b10_1" class="responsive_input_4 button a1_b1_c10_main" style="width:100%;">קבלים במעגלי זרם&nbsp; <span id="a1_b1_c10_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 11 -->
				<table id="table_b11" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b11_1" class="responsive_input_4 button a1_b1_c11_main" style="width:100%;">פריקת וטעינת קבל&nbsp; <span id="a1_b1_c11_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 12 -->
				<table id="table_b12" style="margin-top:2.5px;">
						<tr>
							...
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b12_1" class="responsive_input_4 button a1_b1_c12_main" style="width:100%;">כח על מטען&nbsp; <span id="a1_b1_c12_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 13 -->
				<table id="table_b13" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 13 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_5.png" style="width:95%;"></td>
							
							<!-- SUBJECT 13 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b13_1" class="responsive_input_4 button a1_b1_c13_main" style="width:100%;">כח על זרם&nbsp; <span id="a1_b1_c13_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 14 -->
				<table id="table_b14" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 14 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_5.png" style="width:95%;"></td>
							
							<!-- SUBJECT 14 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b14_1" class="responsive_input_4 button a1_b1_c14_main" style="width:100%;">מקורות שדה מגנטי&nbsp; <span id="a1_b1_c14_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 15 -->
				<table id="table_b15" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 15 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_5.png" style="width:95%;"></td>
							
							<!-- SUBJECT 15 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b15_1" class="responsive_input_4 button a1_b1_c15_main" style="width:100%;">כא"מ מושרה&nbsp; <span id="a1_b1_c15_views"></span></button>
								</div>
							</th>
						</tr>
	...
	<!-- FOOTER -->    
	<footer id="footer_1" style="float:right;clear:both;margin-top:6px;">
	...
	<div id="disqus_thread" style="padding:0px 10px;"></div>
	<script>
	...
	*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
	...
	this.page.url = 'https://course005.explainit.online';  // Replace PAGE_URL with your page's canonical URL variable
	this.page.identifier = 'index'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
	};
	
	(function() { // DON'T EDIT BELOW THIS LINE
	var d = document, s = d.createElement('script');
	s.src = 'https://https-www-course005-explainit-online.disqus.com/embed.js';
	...
	function check_part(part_number)
	{
		...
		if(part_number == 1)
		{
			...
			if(counter == 6)//ALL SUBJECTS INCLUDE GOT_IT CLASS
			{
				//CHANGE PART IMG
	...
	<script id="dsq-count-scr" src="//https-www-course005-explainit-online.disqus.com/count.js" async></script>
	</body>
</html>
<?php
