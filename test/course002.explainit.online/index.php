...
<!-- MIDDLE CONTENT -->	
	...
	<div style="width:100%;text-align:center;float:right;">
		...
		<!-- YOUTUBE PLAYER -->
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/hiZpEPtJQW8?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/wankP8QoERs?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/cNiK88jxBPQ?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/Th8RY5B0GPc?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
