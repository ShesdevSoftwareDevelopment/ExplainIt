...
// SELF POST
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')//POST REQUEST SUBMITTED
	{
		...
		if(mysqli_num_rows($query) > 0)
		{
			...
			echo '<script>setTimeout(function(){$("#c").click();}, 0050);</script>';
		}
			...
			if($Pa_name==$Pa_2_name)//PASSWORDS MATCH
			{
				...
				*/
					...
					*/	
						...
						$f_1="Explainit Online - קורס 002 - נרשם/ת חדש/ה";
						$t=$E_mail;
					...
					/* HTML MAIL WITH PHP *//* https://css-tricks.com/sending-nice-html-email-with-php/ */
						...
						//ATTRIBUTES
						$t=$E_mail;
						$s="Explainit Online - קורס 002 - אישור חשבון";
						...
						$message .= '<div style="width:50%;margin:auto;">
										<a href="https://explainit.online/xo/test/course002.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
