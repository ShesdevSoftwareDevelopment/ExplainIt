		...
		<div id="div_header_3" style="float:right;text-align:center;font-size:24px;position:relative;top:0px;width:100%;">
			...
			<!-- PART 1 -->
				<table id="table_b0" style="margin-top:2.5px;">
						<tr>
							<!-- PART 1 PIC -->
							<th id="b0_1" colspan="4" style="border-right-style:none;"><!-- PART 01 PIC --><!-- OUTPUT 05 --><img class="output" src="../img/table/1.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 01 -->
				<table id="table_b1" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 01 ICON --><!-- OUTPUT 06 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 01 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b1_1" class="responsive_input_4 button a1_b1_c1_main" style="width:100%;">מלכים ב&#39; ט&#34;ו&nbsp;<span id="a1_b1_c1_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<tr class="b1">
							<td id="td_pic_01" colspan="5" style="text-align:center;padding:2px 10px;border-right-style:none;position:relative;"><!-- SUBJECT 01 THUMBNAIL --><!-- OUTPUT 07 --><img class="output" src="../img/login/thumbnails/1.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 02 -->
				<table id="table_b2" style="margin-top:2.5px;">
					<tr>
						<!-- ICON -->
						<th style="width:30px;border-style:none;"><!-- SUBJECT 02 ICON --><!-- OUTPUT 08 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
						
						<!-- SUBJECT 02 -->
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b2_1" class="responsive_input_4 button a1_b1_c2_main" style="width:100%;">מלכים ב&#39; י&#34;ז (חלק א&#39;) <span id="a1_b1_c2_views"></span></button>
							</div>
						</th>
					</tr>
					...
					<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
					<tr class="b2">
						<td id="td_pic_02" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 02 THUMBNAIL --><!-- OUTPUT 09 --><img class="output" src="../img/login/thumbnails/2.jpg" style="width:100%;"></td>
					</tr>
				</table>
			...
			<!-- SUBJECT 03 -->
				<table id="table_b3" style="margin-top:2.5px;">
					<tr>
						<!-- ICON -->
						<th style="width:30px;border-style:none;"><!-- SUBJECT 03 ICON --><!-- OUTPUT 10 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
						
						<!-- SUBJECT 03 -->
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b3_1" class="responsive_input_4 button a1_b1_c3_main" style="width:100%;">מלכים ב&#39; י&#34;ז (חלק ב&#39;) <span id="a1_b1_c3_views"></span></button>
							</div>
						</th>
					</tr>
					...
					<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
					<tr class="b3">
						<td id="td_pic_03" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 03 THUMBNAIL --><!-- OUTPUT 11 --><img class="output" src="../img/login/thumbnails/3.jpg" style="width:100%;"></td>
					</tr>
				</table>
			...
			<!-- SUBJECT 04 -->
				<table id="table_b4" style="margin-top:2.5px;">
					<tr>
						<!-- ICON -->
						<th style="width:30px;border-style:none;"><!-- SUBJECT 04 ICON --><!-- OUTPUT 12 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
						
						<!-- SUBJECT 04 -->
						<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
							<div style="width:100%;margin:auto;">
								<button id="b4_1" class="responsive_input_4 button a1_b1_c4_main" style="width:100%;">עמוס א&#39; <span id="a1_b1_c4_views"></span></button>
							</div>
						</th>
					</tr>
					...
					<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
					<tr class="b4">
						<td id="td_pic_04" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 04 THUMBNAIL --><!-- OUTPUT 13 --><img class="output" src="../img/login/thumbnails/4.jpg" style="width:100%;"></td>
					</tr>
				</table>
			...
			<!-- SUBJECT 05 -->
				<table id="table_b5" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 05 ICON --><!-- OUTPUT 15 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 05 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b5_1" class="responsive_input_4 button a1_b1_c5_main" style="width:100%;">עמוס ד&#39; <span id="a1_b1_c5_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
						<tr class="b5">
							<td id="td_pic_05" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 05 THUMBNAIL --><!-- OUTPUT 16 --><img class="output" src="../img/login/thumbnails/5.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- PART 2 -->
				<table id="table_b01" style="margin-top:2.5px;">
						<tr>
							<!-- PART 2 PIC -->
							<th id="b01_1" colspan="4" style="border-right-style:none;"><!-- PART 2 PIC --><!-- OUTPUT 14 --><img class="output" src="../img/table/2.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;"></td>
						</tr>
				</table>	
			...
			<!-- SUBJECT 06 -->
				<table id="table_b6" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 06 ICON --><!-- OUTPUT 17 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 06 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b6_1" class="responsive_input_4 button a1_b1_c6_main" style="width:100%;">עמוס ה&#39; <span id="a1_b1_c6_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
						<tr class="b6">
							<td id="td_pic_06" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 06 THUMBNAIL --><!-- OUTPUT 18 --><img class="output" src="../img/login/thumbnails/6.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 07 -->
				<table id="table_b7" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 07 ICON --><!-- OUTPUT 19 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 07 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b7_1" class="responsive_input_4 button a1_b1_c7_main" style="width:100%;">מלכים ב&#39; י&#34;ח-י&#34;ט (א&#39;) <span id="a1_b1_c7_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
						<tr class="b7">
							<td id="td_pic_07" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 07 THUMBNAIL --><!-- OUTPUT 20 --><img class="output" src="../img/login/thumbnails/7.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 08 -->
				<table id="table_b8" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT ICON --><!-- OUTPUT 21 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 08 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b8_1" class="responsive_input_4 button a1_b1_c8_main" style="width:100%;">מלכים ב&#39; י&#34;ח-י&#34;ט (ב&#39;) <span id="a1_b1_c8_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
						<tr class="b8">
							<td id="td_pic_08" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 08 THUMBNAIL --><!-- OUTPUT 22 --><img class="output" src="../img/login/thumbnails/8.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 09 -->
				<table id="table_b9" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 09 ICON --><!-- OUTPUT 24 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 09 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b9_1" class="responsive_input_4 button a1_b1_c9_main" style="width:100%;">מלכים ב&#39; י&#34;ח-י&#34;ט (ג&#39;) <span id="a1_b1_c9_views"></span></button>
								</div>
							</th>
						</tr>
						...
						<!-- BACKGROUND IMAGE AND YOUTUBE VIDEO -->
						<tr class="b9">
							<td id="td_pic_09" colspan="5" style="border-right-style:none;text-align:center;border-right-style:none;position:relative;"><!-- SUBJECT 09 THUMBNAIL --><!-- OUTPUT 25 --><img class="output" src="../img/login/thumbnails/9.jpg" style="width:100%;"></td>
						</tr>
				</table>
			...
			<!-- SUBJECT 10 -->
				<table id="table_b10" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 10 ICON --><!-- OUTPUT 26 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 10 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b10_1" class="responsive_input_4 button a1_b1_c10_main" style="width:100%;">מלכים ב&#39; י&#34;ח-י&#34;ט (ד&#39;) <span id="a1_b1_c10_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- PART 3 -->
				<table id="table_b02" style="margin-top:2.5px;">
						<tr>
							<!-- PART 3 PIC -->
							<th id="b02_1" colspan="4" style="border-right-style:none;"><!-- PART 3 PIC --><!-- OUTPUT 23 --><img class="output" src="../img/table/3.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;"></td>
						</tr>
				</table>	
			...
			<!-- SUBJECT 11 -->
				<table id="table_b11" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 11 ICON --><!-- OUTPUT 28 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 11 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b11_1" class="responsive_input_4 button a1_b1_c11_main" style="width:100%;">ישעיה א&#39; (חלק א&#39;) <span id="a1_b1_c11_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 12 -->
				<table id="table_b12" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 12 ICON --><!-- OUTPUT 30 --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 12 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b12_1" class="responsive_input_4 button a1_b1_c12_main" style="width:100%;">ישעיה א&#39; (חלק ב&#39;) <span id="a1_b1_c12_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 13 -->
				<table id="table_b13" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 13 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 13 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b13_1" class="responsive_input_4 button a1_b1_c13_main" style="width:100%;">ישעיה א&#39; (חלק ג&#39;) <span id="a1_b1_c13_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 14 -->
				<table id="table_b14" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 14 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 14 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b14_1" class="responsive_input_4 button a1_b1_c14_main" style="width:100%;">ישעיה א&#39; (חלק ד&#39;) <span id="a1_b1_c14_views"></span></button>
								</div>
							</th>
						</tr>
			...
			<!-- SUBJECT 15 -->
				<table id="table_b15" style="margin-top:2.5px;">
						<tr>
							<!-- ICON -->
							<th style="width:30px;border-style:none;"><!-- SUBJECT 15 ICON --><!-- OUTPUT 30_ --><img class="output" src="../img/icons/BOOKS_2.png" style="width:95%;"></td>
							
							<!-- SUBJECT 15 -->
							<th colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
								<div style="width:100%;margin:auto;">
									<button id="b15_1" class="responsive_input_4 button a1_b1_c15_main" style="width:100%;">ישעיה ב&#39; <span id="a1_b1_c15_views"></span></button>
								</div>
							</th>
						</tr>
...
-->				
	...
	function check_part(part_number)
	{
		...
		if(part_number == 1)
		{
			...
			{
				//CHANGE PART IMG
				$("#b0_1").html('<img class="output" src="../img/table/7.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		...
		else if (part_number == 2)
		{
			...
			{
				//CHANGE PART IMG
				$("#b01_1").html('<img class="output" src="../img/table/8.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		}//CHECKING PART 2
		...
		else if (part_number == 3)
		{
			...
			{
				//CHANGE PART IMG
				$("#b02_1").html('<img class="output" src="../img/table/9.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		}//CHECKING PART 3	
	}//FUNCTION CHECK_PART
	...
	function check_part_2(part_number)
	{
		...
		if(part_number == 1)
		{
			...
			{
				//CHANGE PART IMG
				$("#b0_1").html('<img class="output" src="../img/table/4.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
			else//ALL SUBJECTS UNDERSTOOD/NOT COLORED
			{
				//CHANGE PART IMG
				$("#b0_1").html('<img class="output" src="../img/table/1.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		...
		else if (part_number == 2)
		{
			...
			{
				//CHANGE PART IMG
				$("#b01_1").html('<img class="output" src="../img/table/5.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
			else//ALL SUBJECTS UNDERSTOOD/NOT COLORED
			{
				//CHANGE PART IMG
				$("#b01_1").html('<img class="output" src="../img/table/2.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		}//CHECKING PART 2
		...
		else if (part_number == 3)
		{
			...
			{
				//CHANGE PART IMG
				$("#b02_1").html('<img class="output" src="../img/table/6.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
			else//ALL SUBJECTS UNDERSTOOD/NOT COLORED
			{
				//CHANGE PART IMG
				$("#b02_1").html('<img class="output" src="../img/table/3.jpg" style="margin-bottom:0px;margin-top:0px;width:100%;">');
			}
		}//CHECKING PART 3	
		...
		function(data, status, example_var)
		{
			...
			//GET CURRENT COLORS
				...
				$("#clear_colors_a1_b1_c1").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_01").html('<img class="output" src="../img/login/thumbnails/1.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c2").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_02").html('<img class="output" src="../img/login/thumbnails/2.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c3").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_03").html('<img class="output" src="../img/login/thumbnails/3.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c4").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_04").html('<img class="output" src="../img/login/thumbnails/4.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c5").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_05").html('<img class="output" src="../img/login/thumbnails/5.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c6").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_06").html('<img class="output" src="../img/login/thumbnails/6.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c7").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_07").html('<img class="output" src="../img/login/thumbnails/7.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c8").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_08").html('<img class="output" src="../img/login/thumbnails/8.jpg" style="width:100%;">');
				...
				$("#clear_colors_a1_b1_c9").click(function()
				{
					...
					//UPDATING SUBJECT PIC
					$("#td_pic_09").html('<img class="output" src="../img/login/thumbnails/9.jpg" style="width:100%;">');
				...
				});//END OF SAVE_BUTTON a1_b1_c15 CLICK
