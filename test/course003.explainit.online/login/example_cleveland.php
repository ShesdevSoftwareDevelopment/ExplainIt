			...
			if($Pa_name==$Pa_2_name)//PASSWORDS MATCH
			{
				...
				*/
					...
					*/	
						...
						$f_1="Explainit Online - קורס 003 - נרשם/ת חדש/ה";
						$t=$E_mail;
					...
					/* HTML MAIL WITH PHP *//* https://css-tricks.com/sending-nice-html-email-with-php/ */
						...
						//ATTRIBUTES
						$t=$E_mail;
						$s="Explainit Online - קורס 003 - אישור חשבון";
						...
						$message .= '<div style="width:50%;margin:auto;">
										<a href="https://explainit.online/xo/test/course003.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
...
<div style="direction:rtl;text-align:center;">
	...
	<form action="example_cleveland.php" method="post" enctype="multipart/form-data" autocomplete="on">
		...
		<div style="width:200px;text-align:right;direction:rtl;margin:auto;">
			...
			<label class="container">
			התשלום הוא עבור מנוי עד ל-08.06.19. הארכה תהיה אפשרית בתשלום נוסף כתלות באישור המרצה. 
...
function testcheck()
{
	...
	{
        //ALERT
		alert("חובה לאשר את תנאי השימוש והצהרת הפרטיות, את ההצהרה שאת/ה מבין/ה שעקב אופי המוצר לא יהיה אפשרות לבטל את העסקה ושמדובר במנוי שנתי.");
	...
	{
        //ALERT
		alert("חובה לאשר את ההצהרה שאת/ה מבין/ה שעקב אופי המוצר לא יהיה אפשרות לבטל את העסקה ושמדובר במנוי שנתי.");
	...
	{
        //ALERT
		alert("חובה לאשר את ההצהרה שאת/ה מבין/ה שמדובר במנוי שנתי.");
