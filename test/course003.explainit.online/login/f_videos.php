...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	else//MAIL FOUND
	{
		...
		//ATTRIBUTES
		$s="Explainit Online - קורס 003 - החלפת סיסמה";
		...
		$message .= '<div style="width:50%;margin:auto;">
						<a href="https://explainit.online/xo/test/course003.explainit.online/php/v_fi/v_1_videos.php?e='.$t.'&h='.$P_h.'">
		...
		$f_1="Explainit Online - קורס 003 - החלפת סיסמה";
