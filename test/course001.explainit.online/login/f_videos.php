...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	else//MAIL FOUND
	{
		...
		//ATTRIBUTES
		$s="Explainit Online - קורס 001 - החלפת סיסמה";
		...
		$message .= '<div style="width:50%;margin:auto;">
						<a href="https://www.course001.explainit.online/php/v_fi/v_1_videos.php?e='.$t.'&h='.$P_h.'">
		...
		$f_1="Explainit Online - קורס 001 - החלפת סיסמה";
