...
<!-- MIDDLE CONTENT -->	
	...
	<div style="width:100%;text-align:center;float:right;">
		...
		<div id="div_first_time">
			<div style="width:100%;margin:auto;text-align:center;float:right;"> 
				...
				<!-- SIGN UP --><!-- OUTPUT 08 -->
				<div id="div_header_4_1" style="float:right;">
			...
			<div style="width:100%;margin:auto;text-align:center;float:right;">
				...
				<p>
					...
					עלות החבילה <b>120 ש"ח</b> (במקום <s>180 ש"ח</s>).
					
					תוכל/י לצפות בהם כמה זמן שתרצה/י עד לבחינה.
				</p>
		...
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/ItrCH3DxQZo?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/_JlLYjhThF4?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
		<iframe class="frame" width="100%" height="100%" src="https://www.youtube.com/embed/BpOCExiSrrU?showinfo=0&rel=0" frameborder="0" allowfullscreen></iframe> 
	...
	<footer id="footer_1" style="float:right;clear:both;width:100%;position:relative;">
			<div style="float:right;clear:both;text-align:right;margin-top:5px;width:100%;text-align:center;">
				<!-- OUTPUT 12 --><!-- ABOUT -->
				...
				<a href="credits/credits.php">
					<input class="responsive_input_2 button log_in" type="submit" value="קרדיטים" name="register">
				</a>
				
				<!-- OUTPUT 06 --><!-- INTERESTED IN WEBSITE -->
				<a href="login/first_time/first_time_2.php">
					<input class="responsive_input_2 button log_in" type="submit" value="רוצה אתר כזה?" name="register">
				</a>
			</div>
		</footer>
	</div>
