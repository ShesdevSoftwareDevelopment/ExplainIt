...
/* TABLES */
	...
	@media only screen and (max-width: 710px)
	{
		...
		*/
		...
		{
			width:96%;
			/*height:36px;*//* CANCELLED */
			height:100%;
			margin:4px 2px;
			padding:6px;
			font-size:16px;
			white-space: normal;/* ADDED */
			background-position:0 -50px;/* ADDED */
		}
...
<!-- MIDDLE CONTENT -->	
	...
	<div style="width:100%;text-align:center;float:right;">
		...
		<div id="div_first_time">
			...
			<div style="width:100%;margin:auto;text-align:center;float:right;">
				<!-- TEXT -->
				<p>
					עלות הקורס <b>130 ש"ח</b> (במקום <s>230 ש"ח</s>).
				<br>	
					תוכל/י לצפות בו כמה שתרצה/י עד ל-31.03.19.
				</p>
		...
		<div class="container" style="width:100%;">
			...
			<div class="container_01" style="width:50%;float:left;">
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304035073?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304306764?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->
			...
			<div class="container_01" style="width:50%;float:left;">
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/303979900?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/303974365?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->
			
			<!-- DIVIDER -->
			<div class="container_01" style="width:100%;float:left;">
				<div style="margin-bottom:12px;">
					<table class="table_b00" style="margin-top:2.5px;">
							<tr>
								<!-- DIVIDER --><!-- OUTPUT -->
								<th class="b00_1" colspan="4" style="border-right-style:none;"><img class="output" src="img/index/ODY4730_02.png" style="margin-bottom:0px;margin-top:0px;width:100%;"></td>
							</tr>
					</table>
				</div>
			</div><!-- DIVIDER -->
			...
			<div class="container_01" style="width:50%;float:left;">
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304322413?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/303978408?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->	
			...
			<div class="container_01" style="width:50%;float:left;">
				<div style="margin-bottom:12px;">	
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304041675?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304046285?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>		
			</div><!-- CONTAINER_01 -->
			...
			<div class="container_01" style="width:50%;float:left;">
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/303972246?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304084516?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->
			...
			<div class="container_01" style="width:50%;float:left;">	
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304315920?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/303976805?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->	
			...
			<div class="container_01" style="width:50%;float:left;">	
				<div style="margin-bottom:12px;">	
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304039583?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304043773?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>		
			</div><!-- CONTAINER_01 -->
			...
			<div class="container_01" style="width:50%;float:left;">	
				<div style="margin-bottom:12px;">
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304351404?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
					
					<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/304343381?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
			</div><!-- CONTAINER_01 -->
		</div><!-- CONTAINER -->
	...
	<footer id="footer_1" style="float:right;clear:both;width:100%;position:relative;">
			<div style="float:right;clear:both;text-align:center;margin-top:5px;width:100%;text-align:center;">
				<!-- OUTPUT --><!-- ABOUT -->
				<a href="https://explainit.online/chimikal/index.php">
				...
				<a href="terms/about_xo.jpg">
					<input class="responsive_input_2 button log_in" type="submit" value="אודות" name="register">
				</a>
				
				<!-- OUTPUT 13 --><!-- TERMS -->
				<a href="terms/Terms_of_Service_04.08.18.pdf">
					<input class="responsive_input_2 button log_in" type="submit" value="תנאי שימוש" name="register">
				</a>
				
				<!-- OUTPUT 14 --><!-- PRIVACY -->
				<a href="terms/Privacy_Statement_02.08.18.pdf">
					<input class="responsive_input_2 button log_in" type="submit" value="מדיניות פרטיות" name="register">
				</a>
				
				<!-- OUTPUT 15 --><!-- CONTACT PAGE -->
				<a href="contact/contact.php">
					<input class="responsive_input_2 button log_in" type="submit" value="צור קשר" name="register">
				</a>
				
				<!-- OUTPUT 15_1 --><!-- CONTACT PAGE -->
				<a href="credits/credits.php">
					<input class="responsive_input_2 button log_in" style="/*background-color:#329BFD;*/" type="submit" value="קרדיטים" name="register">
				</a>
				
				<!-- OUTPUT 06 --><!-- INTERESTED IN WEBSITE -->
				<a href="login/first_time/first_time_2.php">
					<input class="responsive_input_2 button log_in" style="/*background-color:#329BFD;*/" type="submit" value="רוצה אתר כזה?" name="register">
				</a>
			</div>
		</footer>
	</div>
	...
	<div style="width:100%;margin:auto;">
		...
		<table id="table_b17" style="margin-top:2.5px;">
				<tr>
					<!-- ICON --><!-- OUTPUT -->
					<th style="width:30px;border-style:none;"><img class="output" src="img/icons/BOOKS_7.png" style="width:95%;"></td>
					
					<!-- SUBJECT 16 -->
					<th id="b17_1" colspan="3" style="border-top:none;border-left:none;border-bottom:none;">
						<div style="width:100%;margin:auto;">
							<a href="https://explainit.online/chimikal/index.php#request">
					...
					<td colspan="5" style="text-align:center;padding:2px 10px;border-right-style:none;position:relative;">
						...
						<div style="position:relative;">
							<a href="https://course001.explainit.online">
								<img src="https://explainit.online/img/01.jpg" style="width:100%;">
							</a>
						</div>
					</td>
				</tr>
		...
		$("#choose_subjects").click(function()
		{
			...
			$.post("php/metal_fi/metal_5_videos.php",
			{
				...
				function(data, status)
				{
					...
					//CLICKS
					//b
					setTimeout(function(){$("#b1_1").click();},5000);
					setTimeout(function(){$("#b2_1").click();},5000);
					setTimeout(function(){$("#b3_1").click();},5000);
					setTimeout(function(){$("#b4_1").click();},5000);
					setTimeout(function(){$("#b5_1").click();},5000);
					setTimeout(function(){$("#b6_1").click();},5000);
					setTimeout(function(){$("#b7_1").click();},5000);
					setTimeout(function(){$("#b8_1").click();},5000);
					setTimeout(function(){$("#b9_1").click();},5000);
					setTimeout(function(){$("#b10_1").click();},5000);
					setTimeout(function(){$("#b11_1").click();},5000);
					setTimeout(function(){$("#b12_1").click();},5000);
					setTimeout(function(){$("#b13_1").click();},5000);
					setTimeout(function(){$("#b14_1").click();},5000);
					setTimeout(function(){$("#b15_1").click();},5000);
					setTimeout(function(){$("#b16_1").click();},5000);
