...
// SELF POST
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')//POST REQUEST SUBMITTED
	{
		...
		{
			$_SESSION['message_1']="יש כבר משתמש עם מייל כזה <br><h4 id='a_2' style='margin:2px auto;'>הכנס/י מייל אחר</h4>";
			...
			if($Pa_name==$Pa_2_name)//PASSWORDS MATCH
			{
				...
				*/
					...
					*/	
						...
						$f_1="Explainit Online - קורס 004 - נרשם/ת חדש/ה";
						$t=$E_mail;
					...
					/* HTML MAIL WITH PHP *//* https://css-tricks.com/sending-nice-html-email-with-php/ */
						...
						//ATTRIBUTES
						$t=$E_mail;
						$s="Explainit Online - קורס 004 - אישור חשבון";
						...
						$message .= '<div style="width:50%;margin:auto;">
										<a href="https://explainit.online/xo/test/course004.explainit.online/php/v_fi/v_videos.php?e='.$t.'&h='.$P_h.'">
...
<div style="direction:rtl;text-align:center;">
	...
	<form action="example_cleveland.php" method="post" enctype="multipart/form-data" autocomplete="on">
		...
		<div style="width:200px;text-align:right;direction:rtl;margin:auto;">
			...
			<label class="container">
			התשלום הוא עבור מנוי עד ל-31.03.19. הארכה תהיה אפשרית בתשלום נוסף כתלות באישור המרצה. 
...
function testcheck()
{
	...
	{
        //ALERT
		alert("חובה לאשר את תנאי השימוש והצהרת הפרטיות, את ההצהרה שאת/ה מבין/ה שעקב אופי המוצר לא יהיה אפשרות לבטל את העסקה ושמדובר במנוי עד ל-31.03.19.");
	...
	{
        //ALERT
		alert("חובה לאשר את תנאי השימוש והצהרת הפרטיות, ואת ההצהרה שאת/ה מבין/ה שעקב אופי המוצר לא יהיה אפשרות לבטל את העסקה.");
	...
	{
        //ALERT
		alert("חובה לאשר את תנאי השימוש והצהרת הפרטיות, ושמדובר במנוי שנתי.");
	...
	{
        //ALERT
		alert("חובה לאשר את ההצהרה שאת/ה מבין/ה שעקב אופי המוצר לא יהיה אפשרות לבטל את העסקה ושמדובר במנוי עד ל-31.03.19.");
	...
	{
        //ALERT
		alert("חובה לאשר את ההצהרה שאת/ה מבין/ה שמדובר במנוי עד ל-31.03.19.");
