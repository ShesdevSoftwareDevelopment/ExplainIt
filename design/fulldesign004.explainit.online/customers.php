...
<div class="header">
	...
	<div style="width:100%;">	
		<h4 style="margin-bottom:0px;display:inline;">(המספרים להמחשה בלבד)</h4>
	</div>
	...
	<div class="header">
		...
		<div style="width:100%;">	
			<h4 style="margin-bottom:0px;display:inline;">84</h4>
		</div>
	</div>
	...
	<div class="header">
		...
		<div style="width:100%;">	
			<h4 style="margin-bottom:0px;display:inline;">20</h4>
		</div>
	...
	<div class="header">
		...
		<div style="width:100%;">	
			<h4 style="margin-bottom:0px;display:inline;">11,757 ש"ח</h4>
		</div>
		...
		<div style="width:100%;">	
			<h4 style="margin-bottom:0px;display:inline;">3,674 ש"ח</h4>
		</div>
	...
	<div class="header">
		...
		<div style="width:100%;">	
			<h4 style="margin-bottom:0px;display:inline;">18.07.19</h4>
		</div>
	...
	<div style="width:100%;">	
		<h4 style="margin-bottom:0px;display:inline;">(לדוגמא)</h4>
	</div>	
