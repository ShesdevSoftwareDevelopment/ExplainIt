<?php
	...
	$query_parameters["supplier"] = "ttxexplainit";// "TERMINAL_NAME" should be replaced by actual terminal name
	$query_parameters["sum"] = "5"; //Transaction sum
	$query_parameters["currency"] = "1"; //Type of currency 1 NIS, 2 USD, 978 EUR, 826 GBP, 392 JPY
	$query_parameters["TranzilaPW"] = "M8kgx3"; // Token password if required
